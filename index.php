                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" action="nilai_siswa.php">
                            ...
                            <div class="row row-space">
                                <div class="col-2">
                                    <div class="input-group">
                                        <label for="tugas">Nilai Praktikum / Tugas</label>
                                        <input class="input--style-4" name="nilai__tugas" required>
                                    </div>
                                </div>
                            <div class="p-t-15">
                                <button class="btn btn--radius-2 btn--blue" type="submit" value="Simpan" name="proses">Submit</button>
                                <button class="btn btn--radius-2 btn--blue" type="submit" value="Simpan" name="proses">Reset</button>
                            </div>
                        </form>
                    </div>
                </div>
